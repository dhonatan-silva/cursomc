...
import com.acme.cursomc.domain.Cidade;
import com.acme.cursomc.domain.Cliente;
import com.acme.cursomc.domain.Endereco;
...
import com.acme.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cidade c1 = new Cidade(null, "Ubertlândia", est1);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "dhonatan.silva85@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "dhonatan_silva@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("45438967", "97865645"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avendida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avendida 10 de Maio", "56", null, "Centro", "112000", cli2, c2);
